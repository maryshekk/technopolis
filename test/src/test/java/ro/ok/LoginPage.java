...
public class LoginPage {
    ...
    {
        driver.findElement(By.xpath("//*[@class='button-pro __wide']")).click();
    }
    ...
    {
        return driver.findElement(By.xpath("//*[@class='input-e login_error']")).getText().equals("Неправильно указан логин и/или пароль");
    }
